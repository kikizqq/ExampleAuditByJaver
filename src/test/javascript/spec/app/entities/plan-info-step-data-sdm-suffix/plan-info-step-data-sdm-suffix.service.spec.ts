...
import {
    IPlanInfoStepDataSdmSuffix,
    PlanInfoStepDataSdmSuffix,
    ValidType,
    ViewPermission
} from 'app/shared/model/plan-info-step-data-sdm-suffix.model';

describe('Service Tests', () => {
    describe('PlanInfoStepDataSdmSuffix Service', () => {
        let injector: TestBed;
        let service: PlanInfoStepDataSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IPlanInfoStepDataSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PlanInfoStepDataSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new PlanInfoStepDataSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PlanInfoStepDataSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new PlanInfoStepDataSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a PlanInfoStepDataSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should return a list of PlanInfoStepDataSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should delete a PlanInfoStepDataSdmSuffix', async () => {
