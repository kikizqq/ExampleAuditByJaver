...
import {
    IPlanInfoStepDataHisSdmSuffix,
    PlanInfoStepDataHisSdmSuffix,
    ValidType,
    ViewPermission
} from 'app/shared/model/plan-info-step-data-his-sdm-suffix.model';

describe('Service Tests', () => {
    describe('PlanInfoStepDataHisSdmSuffix Service', () => {
        let injector: TestBed;
        let service: PlanInfoStepDataHisSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IPlanInfoStepDataHisSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PlanInfoStepDataHisSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new PlanInfoStepDataHisSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PlanInfoStepDataHisSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new PlanInfoStepDataHisSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a PlanInfoStepDataHisSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should return a list of PlanInfoStepDataHisSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should delete a PlanInfoStepDataHisSdmSuffix', async () => {
