...
import {
    IPlanInfoDataHisSdmSuffix,
    PlanInfoDataHisSdmSuffix,
    ValidType,
    ViewPermission
} from 'app/shared/model/plan-info-data-his-sdm-suffix.model';

describe('Service Tests', () => {
    describe('PlanInfoDataHisSdmSuffix Service', () => {
        let injector: TestBed;
        let service: PlanInfoDataHisSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IPlanInfoDataHisSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PlanInfoDataHisSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new PlanInfoDataHisSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PlanInfoDataHisSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new PlanInfoDataHisSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a PlanInfoDataHisSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should return a list of PlanInfoDataHisSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should delete a PlanInfoDataHisSdmSuffix', async () => {
