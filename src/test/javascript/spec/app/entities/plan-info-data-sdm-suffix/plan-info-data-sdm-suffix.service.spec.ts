...
import { IPlanInfoDataSdmSuffix, PlanInfoDataSdmSuffix, ValidType, ViewPermission } from 'app/shared/model/plan-info-data-sdm-suffix.model';

describe('Service Tests', () => {
    describe('PlanInfoDataSdmSuffix Service', () => {
        let injector: TestBed;
        let service: PlanInfoDataSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IPlanInfoDataSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PlanInfoDataSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new PlanInfoDataSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PlanInfoDataSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new PlanInfoDataSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a PlanInfoDataSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should return a list of PlanInfoDataSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should delete a PlanInfoDataSdmSuffix', async () => {
