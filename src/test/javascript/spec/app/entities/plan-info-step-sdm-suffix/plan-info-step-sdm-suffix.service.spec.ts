...
import { IPlanInfoStepSdmSuffix, PlanInfoStepSdmSuffix, ValidType, ViewPermission } from 'app/shared/model/plan-info-step-sdm-suffix.model';

describe('Service Tests', () => {
    describe('PlanInfoStepSdmSuffix Service', () => {
        let injector: TestBed;
        let service: PlanInfoStepSdmSuffixService;
        let httpMock: HttpTestingController;
        let elemDefault: IPlanInfoStepSdmSuffix;
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PlanInfoStepSdmSuffixService);
            httpMock = injector.get(HttpTestingController);
            currentDate = moment();

            elemDefault = new PlanInfoStepSdmSuffix(
                0,
                'AAAAAAA',
                'AAAAAAA',
                'AAAAAAA',
        ...
        describe('Service methods', async () => {
            ...
            it('should create a PlanInfoStepSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        validBegin: currentDate.format(DATE_TIME_FORMAT),
                ...
                service
                    .create(new PlanInfoStepSdmSuffix(null))
                    .pipe(take(1))
            ...
            it('should update a PlanInfoStepSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should return a list of PlanInfoStepSdmSuffix', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB',
                        sortString: 'BBBBBB',
            ...
            it('should delete a PlanInfoStepSdmSuffix', async () => {
