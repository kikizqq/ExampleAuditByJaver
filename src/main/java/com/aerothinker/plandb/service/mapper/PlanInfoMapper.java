 ...
 */
@Mapper(componentModel = "spring", uses = {VerifyRecMapper.class, ParaTypeMapper.class, ParaClassMapper.class, ParaCatMapper.class, ParaStateMapper.class, ParaSourceMapper.class, ParaAttrMapper.class, ParaPropMapper.class, RmsUserMapper.class, RmsDepMapper.class})
